...
class LoginForm(forms.Form):
    username_or_email = forms.CharField(label='用户名或者邮箱',
                               widget=forms.TextInput(
                                   attrs={'class':'form-control','placeholder':'请输入用户名或者邮箱'}))
...
class RegForm(forms.Form):
    username = forms.CharField(label='用户名',
                               max_length=10,
                               min_length=3,
                               widget=forms.TextInput(attrs={'class':'form-control','placeholder':'请输入3-10位的用户名'}))
    ...
    password = forms.CharField(label='输入密码',
                               max_length=12,
                               min_length=6,
                               widget=forms.PasswordInput(attrs={'class':'form-control','placeholder':'请输入6-12位的密码'}))
...
class ChangePasswordForm(forms.Form):
    ...
    new_password_again = forms.CharField(label='请再一次输入新的密码',
                               widget=forms.PasswordInput(
                                   attrs={'class':'form-control','placeholder':'请再一次输入新的密码'}))
